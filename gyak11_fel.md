...
insert into Szemely(nev,szulev,foglalkozas) values('Toth Oto',1980,'pincer');
...
```js
 ...
 update Szemely set vegzettseg = vegzettseg+['gepesz','muszeresz'] where nev='Kiss Bela' and foglalkozas='lakatos' and szulev = 2000 ;
```
